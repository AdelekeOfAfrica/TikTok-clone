        ...
        <div class="pl-3 w-full px-4">
            ...
            <div class="mt-2.5 flex">
                <div class="relative  min-h-[480px] max-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer">
                    <video ref="video" loop muted class="rounded-xl object-cover mx-auto h-full" src="/Reeds.mp4" /> <!-- visit pixabay.com for videos copy the video and paste itin the public directory  -->
                    <img class="absolute right-2 bottom-14" width="90" src="@/assets/images/tiktok.png">
                </div>
